...
function displayTherapists(therapists) {
    ...
    therapists.forEach(therapist => {
        ...
        therapistItem.addEventListener("click",(e) => {
            e.preventDefault();
            ChoosingATherapist(therapist)
        })
    });
}
...
function myFunction() {
    ...
    window.location.href = "./html/indexP.html";
}
...
document.getElementById('search-by-region').addEventListener('click',async function(e) {
    e.preventDefault()
...
document.getElementById('search-by-specialty').addEventListener('click',async function(e) {
    e.preventDefault();
...
function ChoosingATherapist(therapist){
    try {
       ...
       window.location.href = "../html/appointmaent.html";
